...
- 2026-08-16 18:39: review reproduced a second fail-closed gap: a partial legacy envelope with completed ledger rows but no `beats` field could omit the authoritative marker and reactivate browser ledger fallback. The repaired Worker marks every ledger-bearing response canonical, the new regression passes, focused Story proofs pass 3/3, handler tests pass 384/384, reconciliation passes 2/2, and the complete suite target is 1762/1762. Exact-head release verification is required again before merge.
