...
**Status:** repository-first v4, portfolio-ingestion headers, and hosted founder action receipts implemented locally; production promotion held while the Cambium repository packet remains `draft-held`.
