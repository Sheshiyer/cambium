...
| --- | --- | --- |
| `docs/plans/` | 177 files, 110,819,912 bytes (105.69 MiB) | dominant historical/proof payload measured from HEAD |
...
| Markdown files | 81 files, 567,905 bytes | low-cost decision/history context |
