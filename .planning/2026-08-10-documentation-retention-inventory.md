...
| --- | --- | --- |
| `docs/plans/` | 177 files, 110,824,922 bytes (105.69 MiB) | dominant historical/proof payload measured from HEAD |
| `docs/plans/assets/` | 127 files, 110,352,627 bytes (105.24 MiB) | generated/reference proof assets |
| PNG files | 85 files, 110,179,751 bytes (99.42% of `docs/plans`) | primary future retention-review surface |
| Markdown files | 81 files, 567,482 bytes | low-cost decision/history context |
