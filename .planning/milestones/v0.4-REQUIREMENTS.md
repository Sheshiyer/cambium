# Requirements Archive: v0.4 Cambium Infinite-Game Doctrine and Intent Graph

**Archived:** 2026-08-29
**Status:** SHIPPED

This archive preserves v0.4 requirements. The next milestone will establish a new active `.planning/REQUIREMENTS.md` when its planning is approved.
