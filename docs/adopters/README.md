# Cambium Adopter Guides

These guides keep Cambium usable as a standalone fractal tapestry: a clean clone, synthetic demo tenant, optional adapters, and no private company state.
