...
- Live proof runbook: `docs/archive/plans/2026-06-30-tg-miniapp-live-proof-unblock-runbook.md`
...
- Modify: `docs/archive/plans/2026-06-30-tg-miniapp-live-proof-unblock-runbook.md`
...
In `docs/archive/plans/2026-06-30-tg-miniapp-live-proof-unblock-runbook.md`, add a note under signed action smoke:
...
```bash
git add workers/quests/src/live-proof-readiness.test.ts workers/quests/src/live-proof-readiness.mjs docs/archive/plans/2026-06-30-tg-miniapp-live-proof-unblock-runbook.md
