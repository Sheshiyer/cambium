...
- **[`docs/organs.html`](./docs/organs.html)** — **per-organ structure**: each organ (genesis · hands · taste · will · cortex) rendered as the *same* self-similar Φ with its real internals (waves, the 40 clusters, the 7-agent C-suite, the NIM) — plus a **dedicated full page per organ** in [`docs/organs/`](./docs/organs/) (genesis · hands · taste · will · cortex). The detail behind the tapestry diagram.
